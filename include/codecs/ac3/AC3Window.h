/*
 * AC3Window.h - AC-3 transform window, A/52 Table 7.33
...
#ifndef PSYMP3_CODECS_AC3_AC3WINDOW_H
#define PSYMP3_CODECS_AC3_AC3WINDOW_H

namespace PsyMP3 {
namespace Codec {
namespace AC3 {

/// A/52 Table 7.33, w[addr] where addr = 10 * A + B.
///
/// 256 coefficients used back to back to form the 512-point window: the
/// second half is this sequence reversed, which is why only half is printed.
///
...
#endif // PSYMP3_CODECS_AC3_AC3WINDOW_H
