...
constexpr uint32_t CODEC_MLPA = FOURCC('m','l','p','a'); // MLP / Dolby TrueHD
constexpr uint32_t CODEC_AC3  = FOURCC('a','c','-','3'); // AC-3 (ETSI TS 102 366 Annex F)
constexpr uint32_t CODEC_EC3  = FOURCC('e','c','-','3'); // E-AC-3 (ETSI TS 102 366 Annex F)
...
public:
    ...
    std::string getContainerName() const override { return "ISO Base Media (MP4)"; }
