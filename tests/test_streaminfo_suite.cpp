/*
 * test_streaminfo_suite.cpp - streaminfo tests, in one program
...
const Entry kEntries[] = {
    {"test_streaminfo_real_files",  test_streaminfo_real_files_main},
    {"test_streaminfo_recovery",    test_streaminfo_recovery_main},
};
...
int main()
{
    ...
    std::printf("\n=== StreamInfo Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
