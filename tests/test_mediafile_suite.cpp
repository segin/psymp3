/*
 * test_mediafile_suite.cpp - mediafile tests, in one program
...
const Entry kEntries[] = {
    {"test_mediafile",        test_mediafile_main},
    {"test_mediafile_split",  test_mediafile_split_main},
};
...
int main()
{
    ...
    std::printf("\n=== MediaFile Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
