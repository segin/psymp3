/*
 * test_fixed_predictor_suite.cpp - fixed predictor tests, in one program
...
const Entry kEntries[] = {
    {"test_fixed_predictor_overflow",   test_fixed_predictor_overflow_main},
#ifdef HAVE_RAPIDCHECK
    {"test_fixed_predictor_properties", test_fixed_predictor_properties_main},
#endif
};
...
int main()
{
    ...
    std::printf("\n=== Fixed Predictor Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
