/*
 * test_widget_suite.cpp - widget and rendering tests, in one program
...
const Entry kEntries[] = {
    {"test_widget_rendering",          test_widget_rendering_main},
    {"test_complex_script_rendering",  test_complex_script_rendering_main},
    {"test_widget_event_routing",      test_widget_event_routing_main},
    {"test_list_view_selection",       test_list_view_selection_main},
};
...
int main()
{
    ...
    std::printf("\n=== Widget and Rendering Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
