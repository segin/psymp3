...
# Test script for FLAC-in-MP4 support
# This file is part of PsyMP3.

set -e

echo "Building FLAC-in-MP4 support test..."
...
g++ -std=c++17 -I../include -I/usr/include/SDL -D_GNU_SOURCE=1 -D_REENTRANT \
    ...
    -o test_iso_flac_support test_iso_flac_support.cpp \
...
echo "Running FLAC-in-MP4 support test..."
./test_iso_flac_support

echo "FLAC-in-MP4 support test completed successfully!"