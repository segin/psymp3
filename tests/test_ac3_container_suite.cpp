/*
 * test_ac3_container_suite.cpp - ac-3 container and codec tests, in one program
...
/*
 * @TEST_METADATA_BEGIN
 * @TEST_NAME: AC-3 Container and Codec Tests
 * @TEST_AUTHOR: Kirn Gill II <segin2005@gmail.com>
 * @TEST_CREATED: 2026-09-18
 * @TEST_TIMEOUT: 120000
 * @TEST_PARALLEL_SAFE: true
 * @TEST_TAGS: ac3,demuxer,codec,oracle
 * @TEST_METADATA_END
 */

#include <cstdio>

int test_ac3_codec_main();
int test_ac3_null_demuxer_main();
int test_ac3_oracle_main();
...
const Entry kEntries[] = {
    {"test_ac3_codec",         test_ac3_codec_main},
    {"test_ac3_null_demuxer",  test_ac3_null_demuxer_main},
    {"test_ac3_oracle",        test_ac3_oracle_main},
};
...
int main()
{
    ...
    std::printf("\n=== AC-3 Container and Codec Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
