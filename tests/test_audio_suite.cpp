/*
 * test_audio_suite.cpp - audio pipeline tests, in one program
...
const Entry kEntries[] = {
    {"test_audio_buffer_cursor",      test_audio_buffer_cursor_main},
    {"test_audio_frame_assembly",     test_audio_frame_assembly_main},
    {"test_audio_thread_safety",      test_audio_thread_safety_main},
    {"test_audio_threading_pattern",  test_audio_threading_pattern_main},
};
...
int main()
{
    ...
    std::printf("\n=== Audio Pipeline Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
