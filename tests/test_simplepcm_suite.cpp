/*
 * test_simplepcm_suite.cpp - simple pcm codec tests, in one program
...
/*
 * @TEST_METADATA_BEGIN
 * @TEST_NAME: Simple PCM Codec Tests
 * @TEST_AUTHOR: Kirn Gill II <segin2005@gmail.com>
 * @TEST_CREATED: 2026-09-18
 * @TEST_TIMEOUT: 120000
 * @TEST_PARALLEL_SAFE: true
 * @TEST_TAGS: pcm,codec,integration
 * @TEST_METADATA_END
 */

#include <cstdio>

int test_simplepcmcodec_comprehensive_integration_main();
int test_simplepcmcodec_integration_minimal_main();
int test_simplepcmcodec_real_integration_main();
...
const Entry kEntries[] = {
    {"test_simplepcmcodec_comprehensive_integration",  test_simplepcmcodec_comprehensive_integration_main},
    {"test_simplepcmcodec_integration_minimal",        test_simplepcmcodec_integration_minimal_main},
    {"test_simplepcmcodec_real_integration",           test_simplepcmcodec_real_integration_main},
};
...
int main()
{
    ...
    std::printf("\n=== Simple PCM Codec Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
