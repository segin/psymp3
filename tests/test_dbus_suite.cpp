/*
 * test_dbus_suite.cpp - d-bus connection, property and signal tests, in one program
...
const Entry kEntries[] = {
    {"test_dbus_connection_manager",                test_dbus_connection_manager_main},
    {"test_dbus_connection_manager_comprehensive",  test_dbus_connection_manager_comprehensive_main},
    {"test_property_manager",                       test_property_manager_main},
    {"test_property_manager_comprehensive",         test_property_manager_comprehensive_main},
    {"test_signal_emitter",                         test_signal_emitter_main},
    {"test_signal_emitter_comprehensive",           test_signal_emitter_comprehensive_main},
};
...
int main()
{
    ...
    std::printf("\n=== D-Bus Connection, Property and Signal Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
