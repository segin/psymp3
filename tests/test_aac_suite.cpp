/*
 * test_aac_suite.cpp - aac tests, in one program
...
const Entry kEntries[] = {
    {"test_aac_integration",    test_aac_integration_main},
    {"test_aac_output_format",  test_aac_output_format_main},
};
...
int main()
{
    ...
    std::printf("\n=== AAC Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
