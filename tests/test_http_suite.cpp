/*
 * test_http_suite.cpp - http client tests, in one program
...
const Entry kEntries[] = {
    {"test_http_client_parse_url",      test_http_client_parse_url_main},
    {"test_http_iohandler_validation",  test_http_iohandler_validation_main},
};
...
int main()
{
    ...
    std::printf("\n=== HTTP Client Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
