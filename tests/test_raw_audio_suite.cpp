/*
 * test_raw_audio_suite.cpp - raw audio stream tests, in one program
...
const Entry kEntries[] = {
    {"test_raw_audio_stream_integration",  test_raw_audio_stream_integration_main},
#ifdef PSYMP3_TEST_HAVE_G711
    {"test_raw_audio_tag_safety",          test_raw_audio_tag_safety_main},
#endif
};
...
int main()
{
    ...
    std::printf("\n=== Raw Audio Stream Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
