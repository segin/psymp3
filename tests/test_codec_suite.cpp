/*
 * test_codec_suite.cpp - codec framework tests, in one program
...
const Entry kEntries[] = {
    {"test_codec_concurrent_instances",         test_codec_concurrent_instances_main},
    {"test_codec_performance",                  test_codec_performance_main},
    {"test_codec_performance_simple",           test_codec_performance_simple_main},
    {"test_codec_selection_validation_simple",  test_codec_selection_validation_simple_main},
    {"test_codec_thread_safety",                test_codec_thread_safety_main},
    {"test_codec_thread_safety_simple",         test_codec_thread_safety_simple_main},
};
...
int main()
{
    ...
    std::printf("\n=== Codec Framework Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
