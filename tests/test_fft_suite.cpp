/*
 * test_fft_suite.cpp - fft tests, in one program
...
const Entry kEntries[] = {
    {"test_fft_mode",  test_fft_mode_main},
    {"test_fft_unit",  test_fft_unit_main},
};
...
int main()
{
    ...
    std::printf("\n=== FFT Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
