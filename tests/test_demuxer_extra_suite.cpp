/*
 * test_demuxer_extra_suite.cpp - demuxer tag and unit tests, in one program
...
const Entry kEntries[] = {
    {"test_demuxer_tag_extraction",  test_demuxer_tag_extraction_main},
    {"test_demuxer_unit",            test_demuxer_unit_main},
};
...
int main()
{
    ...
    std::printf("\n=== Demuxer Tag and Unit Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
