/*
 * test_tag_suite.cpp - tag framework tests, in one program
...
int test_tag_picture_properties_main();
...
const Entry kEntries[] = {
    {"test_tag_unit",                   test_tag_unit_main},
    {"test_tag_properties",             test_tag_properties_main},
    {"test_tag_factory",                test_tag_factory_main},
    {"test_tag_error_handling_manual",  test_tag_error_handling_manual_main},
    {"test_tag_thread_safety",          test_tag_thread_safety_main},
    {"test_tag_picture_properties",     test_tag_picture_properties_main},
    {"test_tag_picture_unit",           test_tag_picture_unit_main},
};
...
int main()
{
    ...
    std::printf("\n=== Tag Framework Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
