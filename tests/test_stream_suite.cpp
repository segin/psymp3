/*
 * test_stream_suite.cpp - stream tests, in one program
...
const Entry kEntries[] = {
    {"test_stream_tag_integration",  test_stream_tag_integration_main},
#ifdef HAVE_OGGDEMUXER
    {"test_stream_manager",          test_stream_manager_main},
#endif
};
...
int main()
{
    ...
    std::printf("\n=== Stream Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
