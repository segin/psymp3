/*
 * test_demuxer_suite.cpp - demuxer and mediafactory tests, in one program
...
const Entry kEntries[] = {
    {"test_demuxer_factory_unit",       test_demuxer_factory_unit_main},
    {"test_media_factory_unit",         test_media_factory_unit_main},
    {"test_demuxed_stream_unit",        test_demuxed_stream_unit_main},
    {"test_demuxer_integration",        test_demuxer_integration_main},
    {"test_media_factory_integration",  test_media_factory_integration_main},
    {"test_demuxer_performance",        test_demuxer_performance_main},
};
