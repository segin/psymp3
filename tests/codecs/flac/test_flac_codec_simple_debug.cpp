...
int test_flac_codec_simple_debug_main_argv(int argc, char* argv[]) {
    ...
    if (argc == 2) {
        ...
        FLACTestDataUtils::validateTestDataAvailable("FLAC codec simple debug"); // exits 77 if none
...
#endif
/// test_flac_codec_simple_debug took arguments when it was a program of its own.
int test_flac_codec_simple_debug_main()
{
    char program[] = "test_flac_codec_simple_debug";
    char* argv[] = {program, nullptr};
    return test_flac_codec_simple_debug_main_argv(1, argv);
}
