...
int test_flac_mini_player_main_argv(int argc, char* argv[]) {
...
/// test_flac_mini_player took arguments when it was a program of its own.
int test_flac_mini_player_main()
{
    char program[] = "test_flac_mini_player";
    char* argv[] = {program, nullptr};
    return test_flac_mini_player_main_argv(1, argv);
}
