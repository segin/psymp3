 ...
 */
static bool isWithinTolerance(int64_t time_diff_ms) {
 ...
 */
static int64_t calculateTimeDiffMs(uint64_t actual_sample, uint64_t target_sample, uint32_t sample_rate) {
 ...
 */
static void test_property_time_differential_calculation() {
