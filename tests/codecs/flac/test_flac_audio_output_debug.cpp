...
int test_flac_audio_output_debug_main_argv(int argc, char* argv[]) {
...
#endif
/// test_flac_audio_output_debug took arguments when it was a program of its own.
int test_flac_audio_output_debug_main()
{
    char program[] = "test_flac_audio_output_debug";
    char* argv[] = {program, nullptr};
    return test_flac_audio_output_debug_main_argv(1, argv);
}
