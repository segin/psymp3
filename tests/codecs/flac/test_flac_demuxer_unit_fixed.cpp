 ...
 */
namespace {  // so that another test file's MemoryIOHandler cannot be
 ...
 */
namespace {  // so that another test file's FLACFrameReadingTest cannot be
             // mistaken for this one when they share a program
 ...
 */
namespace {  // so that another test file's FLACErrorHandlingTest cannot be
             // mistaken for this one when they share a program
 ...
 */
namespace {  // so that another test file's FLACThreadSafetyTest cannot be
             // mistaken for this one when they share a program
