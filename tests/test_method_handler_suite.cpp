/*
 * test_method_handler_suite.cpp - mpris method handler tests, in one program
...
/*
 * @TEST_METADATA_BEGIN
 * @TEST_NAME: MPRIS Method Handler Tests
 * @TEST_AUTHOR: Kirn Gill II <segin2005@gmail.com>
 * @TEST_CREATED: 2026-09-18
 * @TEST_TIMEOUT: 120000
 * @TEST_PARALLEL_SAFE: true
 * @TEST_TAGS: mpris,dbus,methods
 * @TEST_METADATA_END
 */

#include <cstdio>

int test_method_handler_main();
int test_method_handler_comprehensive_main();
int test_method_handler_simple_main();
...
const Entry kEntries[] = {
    {"test_method_handler",                test_method_handler_main},
    {"test_method_handler_comprehensive",  test_method_handler_comprehensive_main},
    {"test_method_handler_simple",         test_method_handler_simple_main},
};
...
int main()
{
    ...
    std::printf("\n=== MPRIS Method Handler Tests: %zu files, %d failed test(s) in %d file(s), %d skipped ===\n",
