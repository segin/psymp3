...
int test_tag_picture_properties_main_argv(int argc, char* argv[]) {
    (void)argc;
    (void)argv;
...
/// test_tag_picture_properties took arguments when it was a program of its own.
int test_tag_picture_properties_main()
{
    char program[] = "test_tag_picture_properties";
    char* argv[] = {program, nullptr};
    return test_tag_picture_properties_main_argv(1, argv);
}
